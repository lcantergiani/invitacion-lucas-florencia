    ...
    >
      ...
      <div className="relative mx-auto flex min-h-[calc(100svh_-_100px)] w-full max-w-4xl flex-col overflow-hidden rounded-[1.25rem] bg-ivory px-5 py-10 shadow-[0_25px_70px_-30px_rgba(43,41,37,0.45)] ring-1 ring-ink/5 sm:px-16 sm:py-16">
        ...
        >
          ...
          <motion.div
            variants={item}
            className="flex w-full items-start justify-between gap-2 text-[0.64rem] leading-tight tracking-normal sm:gap-6 sm:text-xl"
          >
          ...
          <motion.div variants={item} className="flex flex-col items-center">
            ...
            <p className="mt-8 max-w-3xl text-[0.64rem] leading-relaxed tracking-normal lining-nums tabular-nums sm:mt-14 sm:text-xl">
          ...
          <motion.div
            variants={item}
            className="w-full text-[0.64rem] leading-tight tracking-normal sm:mt-12 sm:text-xl"
          >
